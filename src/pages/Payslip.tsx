...
export default function Payslip() {
  ...
  const { data: payslip, isLoading } = useQuery({
    ...
    queryFn: async (): Promise<PayslipData | null> => {
      ...
      const payrollRun = record.payroll_run as { pay_period_start: string; pay_period_end: string; status: string } | null;
      ...
      return {
        ...
        payPeriod: { startDate: payrollRun?.pay_period_start || "", endDate: payrollRun?.pay_period_end || "" },
        earnings: {
