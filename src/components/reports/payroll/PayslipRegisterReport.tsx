                ...
                <TableRow key={`${record.payrollRunId}-${record.employeeId}`}>
                  ...
                  <TableCell className="text-center">
                    {record.payslipIssued ? (
                      <Badge variant="default" className="bg-success/10 text-success hover:bg-success/15">
                        <CheckCircle className="h-3 w-3 mr-1" />
                        Issued
                      </Badge>
                    ) : (
                      <Badge variant="secondary" className="bg-warning/10 text-warning hover:bg-warning/15">
