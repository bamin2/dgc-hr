...
export function CTCReport() {
  ...
  const handleExportPDF = async () => {
    ...
    const columns = [
      ...
      { key: 'basicSalary', header: 'Basic', format: 'currency' as const },
      { key: 'allowancesTotal', header: 'Allow.', format: 'currency' as const },
      { key: 'grossPay', header: 'Gross', format: 'currency' as const },
      { key: 'employerGosi', header: 'GOSI', format: 'currency' as const },
      { key: 'employerBenefitsCost', header: 'Benefits', format: 'currency' as const },
