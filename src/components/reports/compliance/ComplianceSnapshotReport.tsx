    ...
    <div className="space-y-6">
      ...
      {data?.summary && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className={data.summary.missingDocsCount > 0 ? 'border-destructive/30 bg-destructive/5' : ''}>
          ...
          <Card className={data.summary.expiredDocsCount > 0 ? 'border-destructive/30 bg-destructive/5' : ''}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card className={data.summary.expiringDocsCount > 0 ? 'border-warning/30 bg-warning/5' : ''}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card className={data.summary.gosiMismatchCount > 0 ? 'border-warning/30 bg-warning/5' : ''}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
