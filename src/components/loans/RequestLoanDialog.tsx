                  ...
                  <FormControl>
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="duration" id="req-duration" />
                        <Label htmlFor="req-duration">By Duration</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="installment" id="req-installment" />
                        <Label htmlFor="req-installment">By Installment Amount</Label>
                      </div>
                    </RadioGroup>
                  </FormControl>
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Automatically deduct installments from my salary
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
