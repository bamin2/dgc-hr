    ...
    <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary to-primary/90">
      <div className="relative z-10 flex flex-col h-full w-full p-8 lg:p-12">
        ...
        <div className="mb-auto">
          ...
          />
          <span className="text-sm font-medium tracking-[0.15em] uppercase text-primary-foreground">
            DGC People
          </span>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="w-12 h-px mb-12 bg-primary-foreground/20" />
          ...
          <div className="w-12 h-px mt-12 bg-primary-foreground/20" />
        </div>
