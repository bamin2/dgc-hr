...
} from "@/hooks/useDeductionTemplates";
...
export function DeductionTemplatesSection() {
  ...
  const handleEdit = (template: DeductionTemplate) => {
    setSelectedTemplate(template);
    setDialogOpen(true);
  };

  const handleDelete = (template: DeductionTemplate) => {
    setSelectedTemplate(template);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.success("Deduction template deleted");
    ...
    <>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-lg">Deduction Templates</CardTitle>
        ...
        <CardContent>
          {templates && templates.length > 0 ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              <p>No deduction templates yet</p>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Deduction Template</AlertDialogTitle>
            <AlertDialogDescription>
