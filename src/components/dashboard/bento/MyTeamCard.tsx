...
import { CalendarOff, ArrowRight, Calendar } from "lucide-react";
      ...
      <div className="space-y-2 mb-4">
        {upcomingTimeOff.length === 0 ? (
          ...
          <div className="space-y-2">
            {upcomingTimeOff.slice(0, 4).map((timeOff, index) => {
