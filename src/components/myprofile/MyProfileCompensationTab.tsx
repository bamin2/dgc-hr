        ...
        <div className="relative min-h-[280px]">
          ...
          <div className={!isCompensationVisible ? 'blur-md select-none pointer-events-none' : ''}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              {/* Allowances */}
              <div className="border border-success/50 dark:border-success/30 rounded-xl overflow-hidden">
                <div className="flex justify-between items-center p-4 bg-success/10">
                  <div className="flex items-center gap-2">
              ...
              {/* Deductions */}
              <div className="border border-destructive/50 dark:border-destructive/30 rounded-xl overflow-hidden">
