-- Create RPC function to get all reports overview data in a single call
-- This replaces 16+ separate queries with one optimized function
...
BEGIN
  ...
  -- Get payroll totals by currency
